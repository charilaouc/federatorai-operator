...
func GlobalSectionSetParamterToStatefulset(
...
func GlobalSectionSetParamterToDeployment(
	dep *appsv1.Deployment, asp *alamedaserviceparamter.AlamedaServiceParamter) {
	switch dep.Name {
	...
	case util.AlamedaevictionerDPN:
		...
		util.SetStorageToMountPath(dep, asp.Storages, util.AlamedaevictionerCTN,
	...
	case util.AdmissioncontrollerDPN:
		...
		util.SetStorageToMountPath(dep, asp.Storages, util.AdmissioncontrollerCTN,
	...
	case util.AlamedarecommenderDPN:
		...
		util.SetStorageToMountPath(dep, asp.Storages, util.AlamedarecommenderCTN,
	...
	case util.AlamedaexecutorDPN:
		...
		util.SetStorageToMountPath(dep, asp.Storages, util.AlamedaexecutorCTN,
	...
	case util.AlamedadispatcherDPN:
		...
		util.SetStorageToMountPath(dep, asp.Storages, util.AlamedadispatcherCTN,
	...
	case util.AlamedaanalyzerDPN:
		...
		util.SetStorageToMountPath(dep, asp.Storages, util.AlamedaanalyzerCTN,
	...
	case util.InfluxdbDPN:
		...
		util.SetStorageToMountPath(dep, asp.Storages, util.InfluxdbCTN,
	...
	case util.AlamedaNotifierDPN:
		...
		util.SetStorageToMountPath(dep, asp.Storages, util.AlamedaNofitierCTN,
			"alameda-notifier-type-storage", util.AlamedaGroup)
	case util.FederatoraiAgentDPN:
		util.SetStorageToVolumeSource(dep, asp.Storages,
			"federatorai-agent-type.pvc", util.AlamedaGroup)
		util.SetStorageToMountPath(dep, asp.Storages, util.FederatoraiAgentCTN,
	...
	case util.FederatoraiAgentAppDPN:
		...
		util.SetStorageToMountPath(dep, asp.Storages, util.FederatoraiAgentAppCTN,
	...
	case util.FederatoraiAgentGPUDPN:
		...
		util.SetStorageToMountPath(dep, asp.Storages, util.FederatoraiAgentGPUCTN,
	...
	case util.FederatoraiRestDPN:
		...
		util.SetStorageToMountPath(dep, asp.Storages, util.FederatoraiRestCTN,
	...
	case util.FederatoraiAgentPreloaderDPN:
		...
		util.SetStorageToMountPath(dep, asp.Storages, util.FederatoraiAgentPreloaderCTN,
	...
	case util.FederatoraiFrontendDPN:
		...
		util.SetStorageToMountPath(dep, asp.Storages, util.FederatoraiFrontendCTN,
...
func GlobalSectionSetParamterToDaemonSet(
	ds *appsv1.DaemonSet, asp *alamedaserviceparamter.AlamedaServiceParamter) {
	switch ds.Name {
	case util.AlamedaweavescopeAgentDS:
		util.SetDaemonSetImagePullPolicy(
