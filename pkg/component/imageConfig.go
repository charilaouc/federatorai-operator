...
const (
	...
	defaultImageFederatoraiDataAdapter    = "quay.io/prophetstor/federatorai-data-adapter:latest"
)
...
func NewDefautlImageConfig() ImageConfig {
	return ImageConfig{
		...
		FederatoraiDataAdapter:    defaultImageFederatoraiDataAdapter,
	}
}
...
// SetDataAdapter sets image to imageConfig
func (i *ImageConfig) SetDataAdapter(image string) {
	i.FederatoraiDataAdapter = image
}
